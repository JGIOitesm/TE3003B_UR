...
def move_robot():
    ...
    rospy.init_node("home_robot_george")

    # Create an action client
    client = actionlib.SimpleActionClient('/urgeorge/scaled_pos_joint_traj_controller/follow_joint_trajectory', FollowJointTrajectoryAction)
